...
# MATCH (r:RequirementGroup)-[:PART_OF]->(d)
# OPTIONAL MATCH (r)-[:FULFILLS]->(req:Course)
# WITH s, d, creditsCompleted, completedCourses, r, COLLECT(DISTINCT req) AS requiredCourses
# WITH s, d, creditsCompleted, r,
#      requiredCourses,
...
#        d.name AS degree,
#        creditsCompleted,
#        r.id AS requirementGroupId,
#        r.name AS requirementGroupName,
...
def get_student(sid):
    ...
    RETURN s.id AS id,
        ...
        requirementsCompleted,
        totalRequirements,
        (1.0 * requirementsCompleted / totalRequirements) AS percentRequirementsCompleted
    """
